...
# 1. กำหนดค่าเริ่มต้นใน session_state ถ้ายังไม่มี (เพิ่มข้อ 3 และ 4)
...
def show_result_dialog(ans1, ans2, ans3, ans4):
    ...
    # ตรวจข้อ 3 (แก้ไขคำเฉลยและ f-string)
    if u_ans3 == "phone":
    ...
    # ตรวจข้อ 4 (แก้ไขคำเฉลยและ f-string)
    if u_ans4 == "key":
